    ...
    try:
        ...
        if sys.version_info.major == 2:
            ...
            try:
                ...
                print('HTTP GET error code: ', e.code(), file=sys.stderr)
                print('HTTP GET error message: ', e.message, file=sys.stderr)
            except urllib2.URLError as e:
                print('Failed to make request: ', e.reason, file=sys.stderr)
            return None
